...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        VaryWidth varyWidth = new VaryWidth(particleList, L, W, dt, maxTime, holeSize);

        varyWidth.run();

        VaryHoleSize varyHoleSize = new VaryHoleSize(particleList, varyWidth.getBestFrequency(), L, W, dt, maxTime);
